    ...
    <div>
      ...
      <div className='flex justify-center items-center h-screen'>
        <a
          ...
          className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow lg:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 hover:-translate-y-1 mb-60"
        >
          <img
          ...
          <div className="flex flex-col justify-between p-4 leading-normal">
            ...
            <div>
              ...
              <p className="inline-block border-2 border-green-500 rounded-full p-1 text-green-900 bg-green-100 font-bold ml-1 mb-5">Django</p>
            </div>
          </div>
        </a>
      </div>
